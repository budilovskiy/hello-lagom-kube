...
trait HelloService extends Service {
  ...
  def internalHello(id: String): ServiceCall[NotUsed, String]
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello")
      .withCalls(
        restCall(Method.GET, "/api/external/hello/:id", hello _),//.withAutoAcl(true),
        restCall(Method.POST, "/api/external/hello/:id", useGreeting _)//.withAutoAcl(true),
//        restCall(Method.GET, "/api/internal/hello/:id", internalHello _).withAutoAcl(true)
      )
      .withTopics(
